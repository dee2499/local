         ...
         <div class="row">
            <div class="col-md-8">
               ...
               <form name="form1" id="f1" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group"><label>Phone:</label><input  id="number" class="form-control" type="text" name="phone" ></div>
                  ...
                  <div class="form-group"><label>Country:</label>
                    <select class="form-control" name="country" >
                      <?php
                          $selectcountry=mysql_query("select country from country group by id");
                           while($rowcountry=mysql_fetch_array($selectcountry)){
                  ...
                  <div class="form-group"><label>State:</label>
                      ...
                      <?php
                          ...
                          $selectstate=mysql_query("select state from State group by id");
                          
                           while($rowstate=mysql_fetch_array($selectstate)){
                              echo"<option value=".$rowstate['id'].">".$rowstate['state']."</option>";
                            }
                  ...
                  <select class="form-control" name="city" >
                    <?php
                          ...
                          $selectcity=mysql_query("select city from city group by id");
                          
                           while($rowcity=mysql_fetch_array($selectcity)){
                              echo"<option value=".$rowcity['id'].">".$rowcity['city']."</option>";
                            }
